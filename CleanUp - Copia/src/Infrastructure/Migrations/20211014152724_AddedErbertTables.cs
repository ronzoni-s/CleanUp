...
{
    public partial class AddedErbertTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightPerBag = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BagsPerPolibox = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CustomerAddresss_CustomerAddressId",
                        column: x => x.CustomerAddressId,
                        principalTable: "CustomerAddresss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
