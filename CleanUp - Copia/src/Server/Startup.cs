...
using ErbertPranzi.Server.Middlewares;
using Hangfire;
...
namespace ErbertPranzi.Server
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IStringLocalizer<Startup> localizer, IHostApplicationLifetime hostApplicationLifetime)
        {
