...
using ErbertPranzi.Application.Features.Products.Commands.Delete;
using ErbertPranzi.Application.Features.Products.Commands.Update;
using ErbertPranzi.Application.Features.Products.Queries.Export;
...
namespace ErbertPranzi.Server.Controllers.v1.Catalog
{
