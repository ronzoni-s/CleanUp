...
using ErbertPranzi.Client.Extensions;
...
namespace ErbertPranzi.Client.Pages.Catalog
{
    public partial class Products
    {
        ...
        private bool _hideNotActiveProducts = true;
        ...
        private async Task LoadData(int pageNumber, int pageSize, TableState state)
        {
            ...
            { 
                ...
                Orderby = orderings,
                HideNotActive = _hideNotActiveProducts
            };
        ...
        private void ToggleActiveProducts(bool hide)
        {
            _hideNotActiveProducts = hide;
            _table.ReloadServerData();
        }
        ...
        private async Task InvokeModal(int id = 0)
        {
            ...
            var dialog = _dialogService.Show<UploadProductsModal>(id == 0 ? _localizer["Create"] : _localizer["Edit"], parameters, options);
