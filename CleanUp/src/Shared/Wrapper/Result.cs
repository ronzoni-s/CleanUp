...
namespace CleanUp.Shared.Wrapper
{
    public class Result : IResult
    {
        ...
        {
            return new Result { Succeeded = false, Messages = new List<string> { message }, ErrorCode = code };
        }
        ...
        public static IResult Fail(List<string> messages, string code)
        {
            return new Result { Succeeded = false, Messages = messages, ErrorCode = code };
        }
        ...
        public static Task<IResult> FailAsync(List<string> messages, string code)
        {
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        {
            return new Result<T> { Succeeded = false, Messages = new List<string> { message }, ErrorCode = code };
        }
        ...
        public new static Result<T> Fail(List<string> messages, string code)
        {
            return new Result<T> { Succeeded = false, Messages = messages, ErrorCode = code };
        }
        ...
        public new static Task<Result<T>> FailAsync(string message, string code)
        {
            return Task.FromResult(Fail(message, code));
        }
        ...
        public new static Task<Result<T>> FailAsync(List<string> messages, string code)
        {
            return Task.FromResult(Fail(messages, code));
        }
