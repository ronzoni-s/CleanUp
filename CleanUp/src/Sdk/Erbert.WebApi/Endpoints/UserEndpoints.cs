namespace CleanUp.WebApi.Sdk.Endpoints
{
    public static class UserEndpoints
    {
        ...
        public static string GetWorkDays(string id, DateTime fromDate, DateTime toDate) => $"v1/scheduler/work-day/{id}?fromDate={fromDate.ToString("yyyy-MM-dd")}&toDate={toDate.ToString("yyyy-MM-dd")}";
