        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "(concat([LastName],case when [LastName]<>'' AND [FirstName]<>'' then ' ' else '' end,[FirstName]))"),
